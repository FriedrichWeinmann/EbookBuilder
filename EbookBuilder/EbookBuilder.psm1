...
$script:doDotSource = Get-PSFConfigValue -FullName EbookBuilder.Import.DoDotSource -Fallback $false
if ($EbookBuilder_dotsourcemodule) { $script:doDotSource = $true }
...
$importIndividualFiles = Get-PSFConfigValue -FullName EbookBuilder.Import.IndividualFiles -Fallback $false
if ($EbookBuilder_importIndividualFiles) { $importIndividualFiles = $true }
